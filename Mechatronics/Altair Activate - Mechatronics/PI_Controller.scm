...
<model name="PI_Controller">
  <header formatversion="2" hwxversion="2022.1" script="oml"/>
  <edition>
    <properties>
      <property name="creator" value="thoma"/>
      <property name="creationdate" value="02/27/23 12:10:06"/>
      <property name="revision" value="0"/>
      <property name="lastmodifieddate" value="03/15/23 15:22:58"/>
      <property name="comments" value=""/>
    </properties>
  </edition>
  <initialization>K = 10;&#xA;Ti = 100;</initialization>
  <finalization/>
  <diagram>
    ...
    <link name="" type="Explicit">
      ...
      <points>
        <point x="-514" y="-78"/>
        <point x="-514" y="-20.0000000000001"/>
        <point x="-109" y="-20.0000000000001"/>
      </points>
    </link>
    <link name="" type="Explicit">
      <label position="bottom" visible="0" font="Arial,11" color="255,255,255,255"/>
